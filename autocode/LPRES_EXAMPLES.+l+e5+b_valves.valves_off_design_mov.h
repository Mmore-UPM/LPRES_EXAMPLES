...
//==================================================================
#ifndef LPRES_EXAMPLES__LE5B_valves_valves_off_design_mov_H
#define LPRES_EXAMPLES__LE5B_valves_valves_off_design_mov_H

#include <INTEG_simula.h>

class LPRES_EXAMPLES__LE5B_valves_valves_off_design_mov: public INTEG_simula
{
public:
	// methods to cope with the continuous part
	LPRES_EXAMPLES__LE5B_valves_valves_off_design_mov(const char *mgr=NULL,const char *dirInstall=NULL,bool dmode=false);
	...
	static LPRES_EXAMPLES__LE5B_valves_valves_off_design_mov* s_current;
public: 
