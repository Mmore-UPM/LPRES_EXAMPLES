...
//==================================================================
#include "LPRES_EXAMPLES.+l+e5+b_valves.valves_design.exp1.h"

LPRES_EXAMPLES__LE5B_valves_valves_design_exp1* LPRES_EXAMPLES__LE5B_valves_valves_design_exp1::s_current= NULL;
LPRES_EXAMPLES__LE5B_valves_valves_design_exp1::LPRES_EXAMPLES__LE5B_valves_valves_design_exp1(const char* mgr,const char* installDir,bool dmode):LPRES_EXAMPLES__LE5B_valves_valves_design(mgr,installDir,dmode)
{
m_infoLibraryName = "LPRES_EXAMPLES";
m_infoExperimentName = "exp1";
m_infoExperimentFileName = "LPRES_EXAMPLES.+l+e5+b_valves.valves_design.exp1";
m_infoExperimentFileNameExtra = "exp1";
m_infoExperimentDate = "12/07/2020 12:24:35.380000";
...
rc = 1;
nBounds = 19;// Number of boundary variables
...
void LPRES_EXAMPLES__LE5B_valves_valves_design_exp1::initInternalModels()
{
  LPRES_EXAMPLES__LE5B_valves_valves_design::initInternalModels();
}


void LPRES_EXAMPLES__LE5B_valves_valves_design_exp1::LPRES_EXAMPLES__getPreviousSettings()
{
...
void LPRES_EXAMPLES__LE5B_valves_valves_design_exp1::LPRES_EXAMPLES__restorePreviousSettings()
{
...
int LPRES_EXAMPLES__LE5B_valves_valves_design_exp1::LPRES_EXAMPLES__run_case1_calc1()
{
	// Local variables:
	int rct = 1;
	int rc = 11;
	...
	unkR[537] = unkR[538] ;
	m_boundaryBranch[16] = -1;
	unkR[554] = 140. ;
	m_boundaryBranch[17] = -1;
	unkR[559] = 52100. ;
	m_boundaryBranch[18] = -1;
	unkR[569] = 17700. ;
	EXEC_INIT() ;
	RESET_EVENTS() ;
	...
	setAlgVariableInfo("Heat_exchanger_1.h.T", 1.5e-08, 1.5e-08, 1.79769313e+308, 1.79769313e+308) ;
...
int LPRES_EXAMPLES__LE5B_valves_valves_design_exp1::LPRES_EXAMPLES__run_case1()
{
	// Local variables:
	int rc = 1;

	NEW_BRANCH("Valve_designpoint_design") ;
...
void LPRES_EXAMPLES__LE5B_valves_valves_design_exp1::addExptVariables()
{
...
void LPRES_EXAMPLES__LE5B_valves_valves_design_exp1::runExperiment()
{
	CASE_BEGIN("Valve_designpoint(#1)", 1) ;
	RESET_VARIABLES() ;
...
void LPRES_EXAMPLES__LE5B_valves_valves_design_exp1::initDefaultsLibraryGlobalsInExp()
{
}

/* Initialisation of variables in experiment*/
void LPRES_EXAMPLES__LE5B_valves_valves_design_exp1::initDefaultsExp()
{
}

/* Initialisation of boundaries*/
void LPRES_EXAMPLES__LE5B_valves_valves_design_exp1::evalBoundsExp(double TIME)
{
	if (m_boundsLaw)
		{(*m_boundsLaw)(TIME); return;}
}
/* Initialisation of delays in experiments*/
void LPRES_EXAMPLES__LE5B_valves_valves_design_exp1::initDelaysExpt()
{
}
...
try
{
	...
	LPRES_EXAMPLES__LE5B_valves_valves_design_exp1 ecomodel;
#else
	LPRES_EXAMPLES__LE5B_valves_valves_design_exp1 ecomodel(0,0,true);
...
{
	return new LPRES_EXAMPLES__LE5B_valves_valves_design_exp1(name,dirInstall,d);
}
...
SIMULA_EXPORT_C_EXP INTEG_SlimSimula *fcnExpCreate2(const char *name=NULL,const char *dirInstall=NULL,bool d=false)
{
	...
	try
	{
		INTEG_simula * tmp = new LPRES_EXAMPLES__LE5B_valves_valves_design_exp1(name,dirInstall,d);
