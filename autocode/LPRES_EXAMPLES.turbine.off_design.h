...
//==================================================================
#ifndef LPRES_EXAMPLES__turbine_off_design_H
#define LPRES_EXAMPLES__turbine_off_design_H

#include <INTEG_simula.h>

class LPRES_EXAMPLES__turbine_off_design: public INTEG_simula
{
public:
	// methods to cope with the continuous part
	LPRES_EXAMPLES__turbine_off_design(const char *mgr=NULL,const char *dirInstall=NULL,bool dmode=false);
	...
	static LPRES_EXAMPLES__turbine_off_design* s_current;
public: 
