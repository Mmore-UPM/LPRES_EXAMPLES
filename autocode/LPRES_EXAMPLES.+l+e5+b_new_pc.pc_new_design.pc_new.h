...
//==================================================================
#ifndef LPRES_EXAMPLES__LE5B_new_pc_pc_new_design_pc_new_H
#define LPRES_EXAMPLES__LE5B_new_pc_pc_new_design_pc_new_H
...
class LPRES_EXAMPLES__LE5B_new_pc_pc_new_design_pc_new: public LPRES_EXAMPLES__LE5B_new_pc_pc_new_design
{
public:
	LPRES_EXAMPLES__LE5B_new_pc_pc_new_design_pc_new(const char* mgr= NULL,const char* installDir=NULL,bool dmode=false);
public:
	...
	static LPRES_EXAMPLES__LE5B_new_pc_pc_new_design_pc_new* s_current;
private:


// Experiment variables
	int rc;
	double LPRES_EXAMPLES__LPRES_Altitude_case2_param;
	double LPRES_EXAMPLES__Heat_exchanger_1_f_in_W_case2_param;
