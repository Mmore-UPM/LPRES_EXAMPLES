...
//==================================================================
#ifndef LPRES_EXAMPLES__turbine_diseno_H
#define LPRES_EXAMPLES__turbine_diseno_H

#include <INTEG_simula.h>

class LPRES_EXAMPLES__turbine_diseno: public INTEG_simula
{
public:
	// methods to cope with the continuous part
	LPRES_EXAMPLES__turbine_diseno(const char *mgr=NULL,const char *dirInstall=NULL,bool dmode=false);
	...
	static LPRES_EXAMPLES__turbine_diseno* s_current;
public: 
