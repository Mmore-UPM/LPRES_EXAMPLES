...
//==================================================================
#include "LPRES_EXAMPLES.+l+e5+b_valves.actuaciones_mfv_cambia.actuaciones_mov_ccv_ctes.h"

LPRES_EXAMPLES__LE5B_valves_actuaciones_mfv_cambia_actuaciones_mov_ccv_ctes* LPRES_EXAMPLES__LE5B_valves_actuaciones_mfv_cambia_actuaciones_mov_ccv_ctes::s_current= NULL;
LPRES_EXAMPLES__LE5B_valves_actuaciones_mfv_cambia_actuaciones_mov_ccv_ctes::LPRES_EXAMPLES__LE5B_valves_actuaciones_mfv_cambia_actuaciones_mov_ccv_ctes(const char* mgr,const char* installDir,bool dmode):LPRES_EXAMPLES__LE5B_valves_actuaciones_mfv_cambia(mgr,installDir,dmode)
{
m_infoLibraryName = "LPRES_EXAMPLES";
m_infoExperimentName = "actuaciones_mov_ccv_ctes";
m_infoExperimentFileName = "LPRES_EXAMPLES.+l+e5+b_valves.actuaciones_mfv_cambia.actuaciones_mov_ccv_ctes";
m_infoExperimentFileNameExtra = "actuaciones_mov_ccv_ctes";
m_infoExperimentDate = "08/09/2020 17:25:21.966000";
...
LPRES_EXAMPLES__MFV_A_case1_param = 0.0;
...
void LPRES_EXAMPLES__LE5B_valves_actuaciones_mfv_cambia_actuaciones_mov_ccv_ctes::initInternalModels()
{
  LPRES_EXAMPLES__LE5B_valves_actuaciones_mfv_cambia::initInternalModels();
}


void LPRES_EXAMPLES__LE5B_valves_actuaciones_mfv_cambia_actuaciones_mov_ccv_ctes::LPRES_EXAMPLES__init_case1_calc2()
{
...
int LPRES_EXAMPLES__LE5B_valves_actuaciones_mfv_cambia_actuaciones_mov_ccv_ctes::LPRES_EXAMPLES__run_case1_calc1()
{
	// Local variables:
	int rc = 1;
...
void LPRES_EXAMPLES__LE5B_valves_actuaciones_mfv_cambia_actuaciones_mov_ccv_ctes::LPRES_EXAMPLES__getPreviousSettings()
{
...
void LPRES_EXAMPLES__LE5B_valves_actuaciones_mfv_cambia_actuaciones_mov_ccv_ctes::LPRES_EXAMPLES__restorePreviousSettings()
{
...
int LPRES_EXAMPLES__LE5B_valves_actuaciones_mfv_cambia_actuaciones_mov_ccv_ctes::LPRES_EXAMPLES__run_case1_calc2()
{
	// Local variables:
	int rct = 1;
	int rc = 11;
	...
	unkR[499] = LPRES_EXAMPLES__MFV_A_case1_param ;
	EXEC_INIT() ;
	RESET_EVENTS() ;
	...
	if( LPRES_EXAMPLES__MFV_A_case1_param == 0.00111859425 ) {
	NEW_BRANCH("off_design_ccv_mov_ctes_analysis") ;
	}
	else {
	USE_BRANCH("off_design_ccv_mov_ctes_analysis") ;
	}
	rc = STEADY() ;
...
int LPRES_EXAMPLES__LE5B_valves_actuaciones_mfv_cambia_actuaciones_mov_ccv_ctes::LPRES_EXAMPLES__run_case1()
{
	// Local variables:
	int rc = 1;
	...
	_vi1 = 0 ;
	while ( _vi1 <= 100 ) {
	LPRES_EXAMPLES__MFV_A_case1_param = 0.00111859425 + -9.1859425e-06 * _vi1 ;
	m_boundaryBranch[6] = -1;
	unkR[499] = LPRES_EXAMPLES__MFV_A_case1_param ;
	LPRES_EXAMPLES__globalNameParam_case1 = WRITES("MFV.A=%f",LPRES_EXAMPLES__MFV_A_case1_param);
	...
	WRITEF("case_parametric_output_case1_calc1.csv","MFV.A\n");
	...
	WRITEF("case_parametric_output_case1_calc2.csv","MFV.A\n");
...
void LPRES_EXAMPLES__LE5B_valves_actuaciones_mfv_cambia_actuaciones_mov_ccv_ctes::addExptVariables()
{
	ADD_EXPT_VAR( "SYSTEM_MDL_LIB.t_statusIntegration","ENUM", "", &typ_exp[0]);
	ADD_EXPT_VAR( "LPRES_EXAMPLES__MFV_A_case1_param", "REAL", "",&LPRES_EXAMPLES__MFV_A_case1_param);
...
void LPRES_EXAMPLES__LE5B_valves_actuaciones_mfv_cambia_actuaciones_mov_ccv_ctes::runExperiment()
{
	CASE_BEGIN("off_design_ccv_mov_ctes(#1)", 1) ;
	RESET_VARIABLES() ;
...
void LPRES_EXAMPLES__LE5B_valves_actuaciones_mfv_cambia_actuaciones_mov_ccv_ctes::initDefaultsLibraryGlobalsInExp()
{
}

/* Initialisation of variables in experiment*/
void LPRES_EXAMPLES__LE5B_valves_actuaciones_mfv_cambia_actuaciones_mov_ccv_ctes::initDefaultsExp()
{
}

/* Initialisation of boundaries*/
void LPRES_EXAMPLES__LE5B_valves_actuaciones_mfv_cambia_actuaciones_mov_ccv_ctes::evalBoundsExp(double TIME)
{
	if (m_boundsLaw)
		{(*m_boundsLaw)(TIME); return;}
}
/* Initialisation of delays in experiments*/
void LPRES_EXAMPLES__LE5B_valves_actuaciones_mfv_cambia_actuaciones_mov_ccv_ctes::initDelaysExpt()
{
}
...
try
{
	...
	LPRES_EXAMPLES__LE5B_valves_actuaciones_mfv_cambia_actuaciones_mov_ccv_ctes ecomodel;
#else
	LPRES_EXAMPLES__LE5B_valves_actuaciones_mfv_cambia_actuaciones_mov_ccv_ctes ecomodel(0,0,true);
...
{
	return new LPRES_EXAMPLES__LE5B_valves_actuaciones_mfv_cambia_actuaciones_mov_ccv_ctes(name,dirInstall,d);
}
...
SIMULA_EXPORT_C_EXP INTEG_SlimSimula *fcnExpCreate2(const char *name=NULL,const char *dirInstall=NULL,bool d=false)
{
	...
	try
	{
		INTEG_simula * tmp = new LPRES_EXAMPLES__LE5B_valves_actuaciones_mfv_cambia_actuaciones_mov_ccv_ctes(name,dirInstall,d);
...
{
	sprintf(experimentName,"%s","actuaciones_mov_ccv_ctes");
	isDebug = false;
}
