...
//==================================================================
#ifndef LPRES_EXAMPLES__LE5B_valves_actuaciones_H
#define LPRES_EXAMPLES__LE5B_valves_actuaciones_H

#include <INTEG_simula.h>

class LPRES_EXAMPLES__LE5B_valves_actuaciones: public INTEG_simula
{
public:
	// methods to cope with the continuous part
	LPRES_EXAMPLES__LE5B_valves_actuaciones(const char *mgr=NULL,const char *dirInstall=NULL,bool dmode=false);
	...
	static LPRES_EXAMPLES__LE5B_valves_actuaciones* s_current;
public: 
