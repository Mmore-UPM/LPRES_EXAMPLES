...
//==================================================================
#include "LPRES_EXAMPLES.+l+e5+b_valves.valves_off_design.exp1.h"

LPRES_EXAMPLES__LE5B_valves_valves_off_design_exp1* LPRES_EXAMPLES__LE5B_valves_valves_off_design_exp1::s_current= NULL;
LPRES_EXAMPLES__LE5B_valves_valves_off_design_exp1::LPRES_EXAMPLES__LE5B_valves_valves_off_design_exp1(const char* mgr,const char* installDir,bool dmode):LPRES_EXAMPLES__LE5B_valves_valves_off_design(mgr,installDir,dmode)
{
m_infoLibraryName = "LPRES_EXAMPLES";
m_infoExperimentName = "exp1";
m_infoExperimentFileName = "LPRES_EXAMPLES.+l+e5+b_valves.valves_off_design.exp1";
m_infoExperimentFileNameExtra = "exp1";
m_infoExperimentDate = "11/07/2020 19:53:46.288000";
...
LPRES_EXAMPLES__MFV_A_case2_param = 0.0;
...
void LPRES_EXAMPLES__LE5B_valves_valves_off_design_exp1::initInternalModels()
{
  LPRES_EXAMPLES__LE5B_valves_valves_off_design::initInternalModels();
}


void LPRES_EXAMPLES__LE5B_valves_valves_off_design_exp1::LPRES_EXAMPLES__init_case2_calc2()
{
	...
	unkR[554] = 140. ;
	SAVE_VARS_CATEGORY("case2_calc2_file1", 13, 1, 4) ;
}


int LPRES_EXAMPLES__LE5B_valves_valves_off_design_exp1::LPRES_EXAMPLES__run_case2_calc1()
{
	// Local variables:
	int rc = 1;
...
void LPRES_EXAMPLES__LE5B_valves_valves_off_design_exp1::LPRES_EXAMPLES__getPreviousSettings()
{
...
void LPRES_EXAMPLES__LE5B_valves_valves_off_design_exp1::LPRES_EXAMPLES__restorePreviousSettings()
{
...
int LPRES_EXAMPLES__LE5B_valves_valves_off_design_exp1::LPRES_EXAMPLES__run_case2_calc2()
{
	// Local variables:
	int rct = 1;
	int rc = 11;
	...
	DEBUG_LEVEL = 1 ;
	CALC_BEGIN("analysis(#2)", "steady", LPRES_EXAMPLES__globalNameParam_case2, 1) ;
	TOLTYPE = 1 ;
	TOLERANCE = 0.0001 ;
	SMETHOD = 1 ;
	MAXITER = 10000 ;
	...
	MAXJACEVAL = 60 ;
	MAXBROYDEN = 60 ;
	RESTORE_VARS_CATEGORY("case2_calc2_file1", 13, 1, 4) ;
	m_boundaryBranch[0] = -1;
	unkR[52] = 5.8 ;
	m_boundaryBranch[1] = -1;
	unkR[492] = 21. ;
	...
	unkR[497] = LPRES_EXAMPLES__MFV_A_case2_param ;
	EXEC_INIT() ;
	RESET_EVENTS() ;
	setAlgVariableInfo("CCV.f_in.W", 1.5e-08, 1.5e-08, 1.79769313e+308, 1.79769313e+308) ;
	...
	setAlgVariableInfo("Pump_LOX_OXIDIZER.tau_id", 1.5e-08, 1.5e-08, 1.79769313e+308, 1.79769313e+308) ;
	...
	setAlgVariableInfo("MOV.A", 1.5e-08, 1.5e-08, 1.79769313e+308, 1.79769313e+308) ;
	setAlgVariableInfo("CCV.A", 1.5e-08, 1.5e-08, 1.79769313e+308, 1.79769313e+308) ;
	...
	setResidueInfo(11, 1e-06, 2) ;
	if( LPRES_EXAMPLES__MFV_A_case2_param == 0.00111859425 ) {
	NEW_BRANCH("off_design_param_analysis") ;
	}
	else {
	USE_BRANCH("off_design_param_analysis") ;
	}
	rc = STEADY() ;
...
int LPRES_EXAMPLES__LE5B_valves_valves_off_design_exp1::LPRES_EXAMPLES__run_case2()
{
	// Local variables:
	int rc = 1;
	...
	_vi1 = 0 ;
	while ( _vi1 <= 100 ) {
	LPRES_EXAMPLES__MFV_A_case2_param = 0.00111859425 + -1.042078595e-05 * _vi1 ;
	m_boundaryBranch[6] = -1;
	unkR[497] = LPRES_EXAMPLES__MFV_A_case2_param ;
	LPRES_EXAMPLES__globalNameParam_case2 = WRITES("MFV.A=%f",LPRES_EXAMPLES__MFV_A_case2_param);
	...
	WRITEF("case_parametric_output_case2_calc1.csv","MFV.A\n");

	writeoutput_case2_calc1 = 0 ;
	}
	if( rc == 1 ) {
	WRITEF("case_parametric_output_case2_calc1.csv","%g\n",unkR[497]);

	Mat1[0 + 1*(nrow1-1)] = unkR[497] ;
	_vi2 = 1 ;
	while ( _vi2 <= 1 ) {
	...
	WRITEF("case_parametric_output_case2_calc2.csv","MFV.A\n");

	writeoutput_case2_calc2 = 0 ;
	}
	if( rc == 1 ) {
	WRITEF("case_parametric_output_case2_calc2.csv","%g\n",unkR[497]);

	Mat2[0 + 1*(nrow2-1)] = unkR[497] ;
	_vi5 = 1 ;
	while ( _vi5 <= 1 ) {
...
void LPRES_EXAMPLES__LE5B_valves_valves_off_design_exp1::addExptVariables()
{
	ADD_EXPT_VAR( "SYSTEM_MDL_LIB.t_statusIntegration","ENUM", "", &typ_exp[0]);
	ADD_EXPT_VAR( "LPRES_EXAMPLES__MFV_A_case2_param", "REAL", "",&LPRES_EXAMPLES__MFV_A_case2_param);
...
void LPRES_EXAMPLES__LE5B_valves_valves_off_design_exp1::runExperiment()
{
	CASE_BEGIN("off_design_param(#2)", 1) ;
	RESET_VARIABLES() ;
...
void LPRES_EXAMPLES__LE5B_valves_valves_off_design_exp1::initDefaultsLibraryGlobalsInExp()
{
}

/* Initialisation of variables in experiment*/
void LPRES_EXAMPLES__LE5B_valves_valves_off_design_exp1::initDefaultsExp()
{
}

/* Initialisation of boundaries*/
void LPRES_EXAMPLES__LE5B_valves_valves_off_design_exp1::evalBoundsExp(double TIME)
{
	if (m_boundsLaw)
		{(*m_boundsLaw)(TIME); return;}
}
/* Initialisation of delays in experiments*/
void LPRES_EXAMPLES__LE5B_valves_valves_off_design_exp1::initDelaysExpt()
{
}
...
try
{
	...
	LPRES_EXAMPLES__LE5B_valves_valves_off_design_exp1 ecomodel;
#else
	LPRES_EXAMPLES__LE5B_valves_valves_off_design_exp1 ecomodel(0,0,true);
...
{
	return new LPRES_EXAMPLES__LE5B_valves_valves_off_design_exp1(name,dirInstall,d);
}
...
SIMULA_EXPORT_C_EXP INTEG_SlimSimula *fcnExpCreate2(const char *name=NULL,const char *dirInstall=NULL,bool d=false)
{
	...
	try
	{
		INTEG_simula * tmp = new LPRES_EXAMPLES__LE5B_valves_valves_off_design_exp1(name,dirInstall,d);
