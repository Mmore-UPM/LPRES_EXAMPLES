...
//==================================================================
#ifndef LPRES_EXAMPLES__LE5B_new_pc_pc_new_design_H
#define LPRES_EXAMPLES__LE5B_new_pc_pc_new_design_H

#include <INTEG_simula.h>

class LPRES_EXAMPLES__LE5B_new_pc_pc_new_design: public INTEG_simula
{
public:
	// methods to cope with the continuous part
	LPRES_EXAMPLES__LE5B_new_pc_pc_new_design(const char *mgr=NULL,const char *dirInstall=NULL,bool dmode=false);
	...
	static LPRES_EXAMPLES__LE5B_new_pc_pc_new_design* s_current;
public: 
