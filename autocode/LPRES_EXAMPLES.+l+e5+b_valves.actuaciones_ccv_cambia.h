...
//==================================================================
#ifndef LPRES_EXAMPLES__LE5B_valves_actuaciones_ccv_cambia_H
#define LPRES_EXAMPLES__LE5B_valves_actuaciones_ccv_cambia_H

#include <INTEG_simula.h>

class LPRES_EXAMPLES__LE5B_valves_actuaciones_ccv_cambia: public INTEG_simula
{
public:
	// methods to cope with the continuous part
	LPRES_EXAMPLES__LE5B_valves_actuaciones_ccv_cambia(const char *mgr=NULL,const char *dirInstall=NULL,bool dmode=false);
	...
	static LPRES_EXAMPLES__LE5B_valves_actuaciones_ccv_cambia* s_current;
public: 
