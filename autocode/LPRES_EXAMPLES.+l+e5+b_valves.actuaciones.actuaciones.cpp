...
//==================================================================
#include "LPRES_EXAMPLES.+l+e5+b_valves.actuaciones.actuaciones.h"

LPRES_EXAMPLES__LE5B_valves_actuaciones_actuaciones* LPRES_EXAMPLES__LE5B_valves_actuaciones_actuaciones::s_current= NULL;
LPRES_EXAMPLES__LE5B_valves_actuaciones_actuaciones::LPRES_EXAMPLES__LE5B_valves_actuaciones_actuaciones(const char* mgr,const char* installDir,bool dmode):LPRES_EXAMPLES__LE5B_valves_actuaciones(mgr,installDir,dmode)
{
m_infoLibraryName = "LPRES_EXAMPLES";
m_infoExperimentName = "actuaciones";
m_infoExperimentFileName = "LPRES_EXAMPLES.+l+e5+b_valves.actuaciones.actuaciones";
m_infoExperimentFileNameExtra = "actuaciones";
m_infoExperimentDate = "12/07/2020 18:51:25.108000";
...
LPRES_EXAMPLES__MOV_A_case2_param = 0.0;
...
void LPRES_EXAMPLES__LE5B_valves_actuaciones_actuaciones::initInternalModels()
{
  LPRES_EXAMPLES__LE5B_valves_actuaciones::initInternalModels();
}


void LPRES_EXAMPLES__LE5B_valves_actuaciones_actuaciones::LPRES_EXAMPLES__init_case2_calc2()
{
...
int LPRES_EXAMPLES__LE5B_valves_actuaciones_actuaciones::LPRES_EXAMPLES__run_case2_calc1()
{
	// Local variables:
	int rc = 1;
...
void LPRES_EXAMPLES__LE5B_valves_actuaciones_actuaciones::LPRES_EXAMPLES__getPreviousSettings()
{
...
void LPRES_EXAMPLES__LE5B_valves_actuaciones_actuaciones::LPRES_EXAMPLES__restorePreviousSettings()
{
...
int LPRES_EXAMPLES__LE5B_valves_actuaciones_actuaciones::LPRES_EXAMPLES__run_case2_calc2()
{
	// Local variables:
	int rct = 1;
	int rc = 11;
	...
	unkR[504] = LPRES_EXAMPLES__MOV_A_case2_param ;
	EXEC_INIT() ;
	RESET_EVENTS() ;
	...
	if( LPRES_EXAMPLES__MOV_A_case2_param == 0.00141841841629 ) {
	NEW_BRANCH("off_design_ccv_mfv_ctes_analysis") ;
	}
	else {
	USE_BRANCH("off_design_ccv_mfv_ctes_analysis") ;
	}
	rc = STEADY() ;
...
int LPRES_EXAMPLES__LE5B_valves_actuaciones_actuaciones::LPRES_EXAMPLES__run_case2()
{
	// Local variables:
	int rc = 1;
	...
	_vi1 = 0 ;
	while ( _vi1 <= 100 ) {
	LPRES_EXAMPLES__MOV_A_case2_param = 0.00141841841629 + -1.01841841629e-05 * _vi1 ;
	m_boundaryBranch[7] = -1;
	unkR[504] = LPRES_EXAMPLES__MOV_A_case2_param ;
	LPRES_EXAMPLES__globalNameParam_case2 = WRITES("MOV.A=%f",LPRES_EXAMPLES__MOV_A_case2_param);
	...
	WRITEF("case_parametric_output_case2_calc1.csv","MOV.A\n");
	...
	WRITEF("case_parametric_output_case2_calc2.csv","MOV.A\n");
...
void LPRES_EXAMPLES__LE5B_valves_actuaciones_actuaciones::addExptVariables()
{
	ADD_EXPT_VAR( "SYSTEM_MDL_LIB.t_statusIntegration","ENUM", "", &typ_exp[0]);
	ADD_EXPT_VAR( "LPRES_EXAMPLES__MOV_A_case2_param", "REAL", "",&LPRES_EXAMPLES__MOV_A_case2_param);
...
void LPRES_EXAMPLES__LE5B_valves_actuaciones_actuaciones::runExperiment()
{
	CASE_BEGIN("off_design_ccv_mfv_ctes(#2)", 1) ;
	RESET_VARIABLES() ;
...
void LPRES_EXAMPLES__LE5B_valves_actuaciones_actuaciones::initDefaultsLibraryGlobalsInExp()
{
}

/* Initialisation of variables in experiment*/
void LPRES_EXAMPLES__LE5B_valves_actuaciones_actuaciones::initDefaultsExp()
{
}

/* Initialisation of boundaries*/
void LPRES_EXAMPLES__LE5B_valves_actuaciones_actuaciones::evalBoundsExp(double TIME)
{
	if (m_boundsLaw)
		{(*m_boundsLaw)(TIME); return;}
}
/* Initialisation of delays in experiments*/
void LPRES_EXAMPLES__LE5B_valves_actuaciones_actuaciones::initDelaysExpt()
{
}
...
try
{
	...
	LPRES_EXAMPLES__LE5B_valves_actuaciones_actuaciones ecomodel;
#else
	LPRES_EXAMPLES__LE5B_valves_actuaciones_actuaciones ecomodel(0,0,true);
...
{
	return new LPRES_EXAMPLES__LE5B_valves_actuaciones_actuaciones(name,dirInstall,d);
}
...
SIMULA_EXPORT_C_EXP INTEG_SlimSimula *fcnExpCreate2(const char *name=NULL,const char *dirInstall=NULL,bool d=false)
{
	...
	try
	{
		INTEG_simula * tmp = new LPRES_EXAMPLES__LE5B_valves_actuaciones_actuaciones(name,dirInstall,d);
...
{
	sprintf(experimentName,"%s","actuaciones");
	isDebug = false;
}
