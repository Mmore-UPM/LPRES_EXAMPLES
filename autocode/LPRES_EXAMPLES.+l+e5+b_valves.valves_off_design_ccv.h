...
//==================================================================
#ifndef LPRES_EXAMPLES__LE5B_valves_valves_off_design_ccv_H
#define LPRES_EXAMPLES__LE5B_valves_valves_off_design_ccv_H

#include <INTEG_simula.h>

class LPRES_EXAMPLES__LE5B_valves_valves_off_design_ccv: public INTEG_simula
{
public:
	// methods to cope with the continuous part
	LPRES_EXAMPLES__LE5B_valves_valves_off_design_ccv(const char *mgr=NULL,const char *dirInstall=NULL,bool dmode=false);
	...
	static LPRES_EXAMPLES__LE5B_valves_valves_off_design_ccv* s_current;
public: 
