...
//==================================================================
#include "LPRES_EXAMPLES.turbine.off_design_m_2.map_m_2.h"

LPRES_EXAMPLES__turbine_off_design_m_2_map_m_2* LPRES_EXAMPLES__turbine_off_design_m_2_map_m_2::s_current= NULL;
LPRES_EXAMPLES__turbine_off_design_m_2_map_m_2::LPRES_EXAMPLES__turbine_off_design_m_2_map_m_2(const char* mgr,const char* installDir,bool dmode):LPRES_EXAMPLES__turbine_off_design_m_2(mgr,installDir,dmode)
{
m_infoLibraryName = "LPRES_EXAMPLES";
m_infoExperimentName = "map_m_2";
m_infoExperimentFileName = "LPRES_EXAMPLES.turbine.off_design_m_2.map_m_2";
m_infoExperimentFileNameExtra = "map_m_2";
m_infoExperimentDate = "12/07/2020 21:32:52.030000";
...
void LPRES_EXAMPLES__turbine_off_design_m_2_map_m_2::initInternalModels()
{
  LPRES_EXAMPLES__turbine_off_design_m_2::initInternalModels();
}


int LPRES_EXAMPLES__turbine_off_design_m_2_map_m_2::LPRES_EXAMPLES__run_case1_calc1()
{
	// Local variables:
	int rc = 1;

	CALC_BEGIN("ImportGeometry(#1)", "restoreState", "", 1) ;
	RESTORE_STATE("@LPRES_EXAMPLES@/experiments/turbine.design_m_2/design_m_2/report.rpt.xml") ;
	CALC_END(1) ;
	return rc ;
}


void LPRES_EXAMPLES__turbine_off_design_m_2_map_m_2::LPRES_EXAMPLES__getPreviousSettings()
{
...
void LPRES_EXAMPLES__turbine_off_design_m_2_map_m_2::LPRES_EXAMPLES__restorePreviousSettings()
{
...
int LPRES_EXAMPLES__turbine_off_design_m_2_map_m_2::LPRES_EXAMPLES__run_case1_calc2()
{
	// Local variables:
	int rc = 1;
	...
	std::string xParameterNames[1111];
	{int __i=0; for(; __i <1111; __i++) xParameterNames[__i] = ""; };
	std::string yOutputNames[3];
	{int __i=0; for(; __i <3; __i++) yOutputNames[__i] = ""; };
	double Mat[3333];
	memset(Mat,0,3333*sizeof(double));
	int MatOK[3333];
	memset(MatOK,0,3333*sizeof(int));
	int nrow = 0;
	int _vi1;
	int _vi2;
	int _vi3;
	...
	unkR[72] = 12500. + _vi1 * 1750. ;
	NEW_BRANCH(getValueAsString("Turbine.rpm")) ;
	_vi2 = 0 ;
	while ( _vi2 <= 100 ) {
	unkR[42] = 0.01 + _vi2 * 0.0029 ;
	rcs = STEADY() ;
	nrow = nrow + 1 ;
	...
	matPrint(1111, 3, Mat, 1, MatOK, xParameterNames, yOutputNames, "") ;
...
int LPRES_EXAMPLES__turbine_off_design_m_2_map_m_2::LPRES_EXAMPLES__run_case1_calc3()
{
	// Local variables:
	int rc = 1;
...
int LPRES_EXAMPLES__turbine_off_design_m_2_map_m_2::LPRES_EXAMPLES__run_case1_calc4()
{
	// Local variables:
	int rct = 1;
	int rc = 11;
...
int LPRES_EXAMPLES__turbine_off_design_m_2_map_m_2::LPRES_EXAMPLES__run_case1()
{
	// Local variables:
	int rc = 1;
...
void LPRES_EXAMPLES__turbine_off_design_m_2_map_m_2::addExptVariables()
{
...
void LPRES_EXAMPLES__turbine_off_design_m_2_map_m_2::runExperiment()
{
...
void LPRES_EXAMPLES__turbine_off_design_m_2_map_m_2::initDefaultsLibraryGlobalsInExp()
{
}

/* Initialisation of variables in experiment*/
void LPRES_EXAMPLES__turbine_off_design_m_2_map_m_2::initDefaultsExp()
{
}

/* Initialisation of boundaries*/
void LPRES_EXAMPLES__turbine_off_design_m_2_map_m_2::evalBoundsExp(double TIME)
{
	if (m_boundsLaw)
		{(*m_boundsLaw)(TIME); return;}
}
/* Initialisation of delays in experiments*/
void LPRES_EXAMPLES__turbine_off_design_m_2_map_m_2::initDelaysExpt()
{
}
...
try
{
	...
	LPRES_EXAMPLES__turbine_off_design_m_2_map_m_2 ecomodel;
#else
	LPRES_EXAMPLES__turbine_off_design_m_2_map_m_2 ecomodel(0,0,true);
...
{
	return new LPRES_EXAMPLES__turbine_off_design_m_2_map_m_2(name,dirInstall,d);
}
...
SIMULA_EXPORT_C_EXP INTEG_SlimSimula *fcnExpCreate2(const char *name=NULL,const char *dirInstall=NULL,bool d=false)
{
	...
	try
	{
		INTEG_simula * tmp = new LPRES_EXAMPLES__turbine_off_design_m_2_map_m_2(name,dirInstall,d);
...
{
	sprintf(experimentName,"%s","map_m_2");
	isDebug = false;
}
