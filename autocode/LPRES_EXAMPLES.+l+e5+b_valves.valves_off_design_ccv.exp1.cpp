...
//==================================================================
#include "LPRES_EXAMPLES.+l+e5+b_valves.valves_off_design_ccv.exp1.h"

LPRES_EXAMPLES__LE5B_valves_valves_off_design_ccv_exp1* LPRES_EXAMPLES__LE5B_valves_valves_off_design_ccv_exp1::s_current= NULL;
LPRES_EXAMPLES__LE5B_valves_valves_off_design_ccv_exp1::LPRES_EXAMPLES__LE5B_valves_valves_off_design_ccv_exp1(const char* mgr,const char* installDir,bool dmode):LPRES_EXAMPLES__LE5B_valves_valves_off_design_ccv(mgr,installDir,dmode)
{
m_infoLibraryName = "LPRES_EXAMPLES";
m_infoExperimentName = "exp1";
m_infoExperimentFileName = "LPRES_EXAMPLES.+l+e5+b_valves.valves_off_design_ccv.exp1";
m_infoExperimentFileNameExtra = "exp1";
m_infoExperimentDate = "06/09/2020 19:35:27.097000";
...
void LPRES_EXAMPLES__LE5B_valves_valves_off_design_ccv_exp1::initInternalModels()
{
  LPRES_EXAMPLES__LE5B_valves_valves_off_design_ccv::initInternalModels();
}


void LPRES_EXAMPLES__LE5B_valves_valves_off_design_ccv_exp1::LPRES_EXAMPLES__init_case1_calc2()
{
...
int LPRES_EXAMPLES__LE5B_valves_valves_off_design_ccv_exp1::LPRES_EXAMPLES__run_case1_calc1()
{
	// Local variables:
	int rc = 1;
...
void LPRES_EXAMPLES__LE5B_valves_valves_off_design_ccv_exp1::LPRES_EXAMPLES__getPreviousSettings()
{
...
void LPRES_EXAMPLES__LE5B_valves_valves_off_design_ccv_exp1::LPRES_EXAMPLES__restorePreviousSettings()
{
...
int LPRES_EXAMPLES__LE5B_valves_valves_off_design_ccv_exp1::LPRES_EXAMPLES__run_case1_calc2()
{
	// Local variables:
	int rct = 1;
	int rc = 11;
	...
	setAlgVariableInfo("Turbine_FUEL.f_in.pt", 1.5e-08, 1.5e-08, 1.79769313e+308, 1.79769313e+308) ;
	...
	NEW_BRANCH("off_design_ccv_analysis") ;
	}
	else {
	USE_BRANCH("off_design_ccv_analysis") ;
	}
	rc = STEADY() ;
...
int LPRES_EXAMPLES__LE5B_valves_valves_off_design_ccv_exp1::LPRES_EXAMPLES__run_case1()
{
	// Local variables:
	int rc = 1;
	...
	_vi1 = 0 ;
	while ( _vi1 <= 100 ) {
	LPRES_EXAMPLES__CCV_A_case1_param = 0.000748597693 + -7.26042793e-06 * _vi1 ;
	m_boundaryBranch[0] = -1;
	unkR[0] = LPRES_EXAMPLES__CCV_A_case1_param ;
...
void LPRES_EXAMPLES__LE5B_valves_valves_off_design_ccv_exp1::addExptVariables()
{
...
void LPRES_EXAMPLES__LE5B_valves_valves_off_design_ccv_exp1::runExperiment()
{
	CASE_BEGIN("off_design_ccv(#1)", 1) ;
	RESET_VARIABLES() ;
...
void LPRES_EXAMPLES__LE5B_valves_valves_off_design_ccv_exp1::initDefaultsLibraryGlobalsInExp()
{
}

/* Initialisation of variables in experiment*/
void LPRES_EXAMPLES__LE5B_valves_valves_off_design_ccv_exp1::initDefaultsExp()
{
}

/* Initialisation of boundaries*/
void LPRES_EXAMPLES__LE5B_valves_valves_off_design_ccv_exp1::evalBoundsExp(double TIME)
{
	if (m_boundsLaw)
		{(*m_boundsLaw)(TIME); return;}
}
/* Initialisation of delays in experiments*/
void LPRES_EXAMPLES__LE5B_valves_valves_off_design_ccv_exp1::initDelaysExpt()
{
}
...
try
{
	...
	LPRES_EXAMPLES__LE5B_valves_valves_off_design_ccv_exp1 ecomodel;
#else
	LPRES_EXAMPLES__LE5B_valves_valves_off_design_ccv_exp1 ecomodel(0,0,true);
...
{
	return new LPRES_EXAMPLES__LE5B_valves_valves_off_design_ccv_exp1(name,dirInstall,d);
}
...
SIMULA_EXPORT_C_EXP INTEG_SlimSimula *fcnExpCreate2(const char *name=NULL,const char *dirInstall=NULL,bool d=false)
{
	...
	try
	{
		INTEG_simula * tmp = new LPRES_EXAMPLES__LE5B_valves_valves_off_design_ccv_exp1(name,dirInstall,d);
