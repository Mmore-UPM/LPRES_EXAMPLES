...
//==================================================================
#include "LPRES_EXAMPLES.+l+e5+b.design.design_point.h"

LPRES_EXAMPLES__LE5B_design_design_point* LPRES_EXAMPLES__LE5B_design_design_point::s_current= NULL;
LPRES_EXAMPLES__LE5B_design_design_point::LPRES_EXAMPLES__LE5B_design_design_point(const char* mgr,const char* installDir,bool dmode):LPRES_EXAMPLES__LE5B_design(mgr,installDir,dmode)
{
m_infoLibraryName = "LPRES_EXAMPLES";
m_infoExperimentName = "design_point";
m_infoExperimentFileName = "LPRES_EXAMPLES.+l+e5+b.design.design_point";
m_infoExperimentFileNameExtra = "design_point";
m_infoExperimentDate = "12/07/2020 21:26:13.323000";
...
void LPRES_EXAMPLES__LE5B_design_design_point::initInternalModels()
{
  LPRES_EXAMPLES__LE5B_design::initInternalModels();
}


void LPRES_EXAMPLES__LE5B_design_design_point::LPRES_EXAMPLES__getPreviousSettings()
{
...
void LPRES_EXAMPLES__LE5B_design_design_point::LPRES_EXAMPLES__restorePreviousSettings()
{
...
int LPRES_EXAMPLES__LE5B_design_design_point::LPRES_EXAMPLES__run_case1_calc1()
{
	// Local variables:
	int rct = 1;
	int rc = 11;
...
int LPRES_EXAMPLES__LE5B_design_design_point::LPRES_EXAMPLES__run_case1()
{
	// Local variables:
	int rc = 1;

	NEW_BRANCH("case1_design") ;
...
void LPRES_EXAMPLES__LE5B_design_design_point::addExptVariables()
{
...
void LPRES_EXAMPLES__LE5B_design_design_point::runExperiment()
{
...
void LPRES_EXAMPLES__LE5B_design_design_point::initDefaultsLibraryGlobalsInExp()
{
}

/* Initialisation of variables in experiment*/
void LPRES_EXAMPLES__LE5B_design_design_point::initDefaultsExp()
{
}

/* Initialisation of boundaries*/
void LPRES_EXAMPLES__LE5B_design_design_point::evalBoundsExp(double TIME)
{
	if (m_boundsLaw)
		{(*m_boundsLaw)(TIME); return;}
}
/* Initialisation of delays in experiments*/
void LPRES_EXAMPLES__LE5B_design_design_point::initDelaysExpt()
{
}
...
try
{
	...
	LPRES_EXAMPLES__LE5B_design_design_point ecomodel;
#else
	LPRES_EXAMPLES__LE5B_design_design_point ecomodel(0,0,true);
...
{
	return new LPRES_EXAMPLES__LE5B_design_design_point(name,dirInstall,d);
}
...
SIMULA_EXPORT_C_EXP INTEG_SlimSimula *fcnExpCreate2(const char *name=NULL,const char *dirInstall=NULL,bool d=false)
{
	...
	try
	{
		INTEG_simula * tmp = new LPRES_EXAMPLES__LE5B_design_design_point(name,dirInstall,d);
...
{
	sprintf(experimentName,"%s","design_point");
	isDebug = false;
}
