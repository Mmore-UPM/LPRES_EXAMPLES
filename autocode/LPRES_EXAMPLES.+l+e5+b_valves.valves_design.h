...
//==================================================================
#ifndef LPRES_EXAMPLES__LE5B_valves_valves_design_H
#define LPRES_EXAMPLES__LE5B_valves_valves_design_H

#include <INTEG_simula.h>

class LPRES_EXAMPLES__LE5B_valves_valves_design: public INTEG_simula
{
public:
	// methods to cope with the continuous part
	LPRES_EXAMPLES__LE5B_valves_valves_design(const char *mgr=NULL,const char *dirInstall=NULL,bool dmode=false);
	...
	static LPRES_EXAMPLES__LE5B_valves_valves_design* s_current;
public: 
	...
	double LPRES__Lv(double fluid[]);
	double LPRES__T_boil(double fluid[]);
	void LPRES__Obtain_Vap_Prop(double fluid_in[],double Cp_i[],double Lv_i[],double T_boil_i[],double fluid_out[]);
...
void fbox6(double *_time,double dyn[],double ldr[],double res[]);
static void fcn6(int *n, double x[], double residues[], int *iflag);
void fhyb6(double dyn[], double ldr[], double tol, int n, int itmax);
...
void fbox8(double *_time,double dyn[],double ldr[],double res[]);
static void fcn8(int *n, double x[], double residues[], int *iflag);
void fhyb8(double dyn[], double ldr[], double tol, int n, int itmax);
void fbox9(double *_time,double dyn[],double ldr[],double res[]);
static void fcn9(int *n, double x[], double residues[], int *iflag);
void fhyb9(double dyn[], double ldr[], double tol, int n, int itmax);
