...
//==================================================================
#include "LPRES_EXAMPLES.+l+e5+b_valves.valves_off_design_mov.exp1.h"

LPRES_EXAMPLES__LE5B_valves_valves_off_design_mov_exp1* LPRES_EXAMPLES__LE5B_valves_valves_off_design_mov_exp1::s_current= NULL;
LPRES_EXAMPLES__LE5B_valves_valves_off_design_mov_exp1::LPRES_EXAMPLES__LE5B_valves_valves_off_design_mov_exp1(const char* mgr,const char* installDir,bool dmode):LPRES_EXAMPLES__LE5B_valves_valves_off_design_mov(mgr,installDir,dmode)
{
m_infoLibraryName = "LPRES_EXAMPLES";
m_infoExperimentName = "exp1";
m_infoExperimentFileName = "LPRES_EXAMPLES.+l+e5+b_valves.valves_off_design_mov.exp1";
m_infoExperimentFileNameExtra = "exp1";
m_infoExperimentDate = "11/07/2020 19:54:03.004000";
...
LPRES_EXAMPLES__MOV_A_case1_param = 0.0;
...
void LPRES_EXAMPLES__LE5B_valves_valves_off_design_mov_exp1::initInternalModels()
{
  LPRES_EXAMPLES__LE5B_valves_valves_off_design_mov::initInternalModels();
}


void LPRES_EXAMPLES__LE5B_valves_valves_off_design_mov_exp1::LPRES_EXAMPLES__init_case1_calc2()
{
...
int LPRES_EXAMPLES__LE5B_valves_valves_off_design_mov_exp1::LPRES_EXAMPLES__run_case1_calc1()
{
	// Local variables:
	int rc = 1;
...
void LPRES_EXAMPLES__LE5B_valves_valves_off_design_mov_exp1::LPRES_EXAMPLES__getPreviousSettings()
{
...
void LPRES_EXAMPLES__LE5B_valves_valves_off_design_mov_exp1::LPRES_EXAMPLES__restorePreviousSettings()
{
...
int LPRES_EXAMPLES__LE5B_valves_valves_off_design_mov_exp1::LPRES_EXAMPLES__run_case1_calc2()
{
	// Local variables:
	int rct = 1;
	int rc = 11;
	...
	unkR[501] = LPRES_EXAMPLES__MOV_A_case1_param ;
	EXEC_INIT() ;
	RESET_EVENTS() ;
	...
	setAlgVariableInfo("MFV.A", 1.5e-08, 1.5e-08, 1.79769313e+308, 1.79769313e+308) ;
	...
	if( LPRES_EXAMPLES__MOV_A_case1_param == 0.00141841841629 ) {
	NEW_BRANCH("off_design_mov_analysis") ;
	}
	else {
	USE_BRANCH("off_design_mov_analysis") ;
	}
	rc = STEADY() ;
...
int LPRES_EXAMPLES__LE5B_valves_valves_off_design_mov_exp1::LPRES_EXAMPLES__run_case1()
{
	// Local variables:
	int rc = 1;
	...
	_vi1 = 0 ;
	while ( _vi1 <= 100 ) {
	LPRES_EXAMPLES__MOV_A_case1_param = 0.00141841841629 + -1.41741841629e-05 * _vi1 ;
	m_boundaryBranch[6] = -1;
	unkR[501] = LPRES_EXAMPLES__MOV_A_case1_param ;
	LPRES_EXAMPLES__globalNameParam_case1 = WRITES("MOV.A=%f",LPRES_EXAMPLES__MOV_A_case1_param);
	...
	WRITEF("case_parametric_output_case1_calc1.csv","MOV.A\n");
	...
	WRITEF("case_parametric_output_case1_calc2.csv","MOV.A\n");
...
void LPRES_EXAMPLES__LE5B_valves_valves_off_design_mov_exp1::addExptVariables()
{
	ADD_EXPT_VAR( "SYSTEM_MDL_LIB.t_statusIntegration","ENUM", "", &typ_exp[0]);
	ADD_EXPT_VAR( "LPRES_EXAMPLES__MOV_A_case1_param", "REAL", "",&LPRES_EXAMPLES__MOV_A_case1_param);
...
void LPRES_EXAMPLES__LE5B_valves_valves_off_design_mov_exp1::runExperiment()
{
	CASE_BEGIN("off_design_mov(#1)", 1) ;
	RESET_VARIABLES() ;
...
void LPRES_EXAMPLES__LE5B_valves_valves_off_design_mov_exp1::initDefaultsLibraryGlobalsInExp()
{
}

/* Initialisation of variables in experiment*/
void LPRES_EXAMPLES__LE5B_valves_valves_off_design_mov_exp1::initDefaultsExp()
{
}

/* Initialisation of boundaries*/
void LPRES_EXAMPLES__LE5B_valves_valves_off_design_mov_exp1::evalBoundsExp(double TIME)
{
	if (m_boundsLaw)
		{(*m_boundsLaw)(TIME); return;}
}
/* Initialisation of delays in experiments*/
void LPRES_EXAMPLES__LE5B_valves_valves_off_design_mov_exp1::initDelaysExpt()
{
}
...
try
{
	...
	LPRES_EXAMPLES__LE5B_valves_valves_off_design_mov_exp1 ecomodel;
#else
	LPRES_EXAMPLES__LE5B_valves_valves_off_design_mov_exp1 ecomodel(0,0,true);
...
{
	return new LPRES_EXAMPLES__LE5B_valves_valves_off_design_mov_exp1(name,dirInstall,d);
}
...
SIMULA_EXPORT_C_EXP INTEG_SlimSimula *fcnExpCreate2(const char *name=NULL,const char *dirInstall=NULL,bool d=false)
{
	...
	try
	{
		INTEG_simula * tmp = new LPRES_EXAMPLES__LE5B_valves_valves_off_design_mov_exp1(name,dirInstall,d);
