...
//==================================================================
#include "LPRES_EXAMPLES.+turbine_test.off_design.mapa.h"

LPRES_EXAMPLES__Turbine_test_off_design_mapa* LPRES_EXAMPLES__Turbine_test_off_design_mapa::s_current= NULL;
LPRES_EXAMPLES__Turbine_test_off_design_mapa::LPRES_EXAMPLES__Turbine_test_off_design_mapa(const char* mgr,const char* installDir,bool dmode):LPRES_EXAMPLES__Turbine_test_off_design(mgr,installDir,dmode)
{
m_infoLibraryName = "LPRES_EXAMPLES";
m_infoExperimentName = "mapa";
m_infoExperimentFileName = "LPRES_EXAMPLES.+turbine_test.off_design.mapa";
m_infoExperimentFileNameExtra = "mapa";
m_infoExperimentDate = "05/06/2020 14:22:13.115000";
...
void LPRES_EXAMPLES__Turbine_test_off_design_mapa::initInternalModels()
{
  LPRES_EXAMPLES__Turbine_test_off_design::initInternalModels();
}


int LPRES_EXAMPLES__Turbine_test_off_design_mapa::LPRES_EXAMPLES__run_case1_calc1()
{
	// Local variables:
	int rc = 1;

	CALC_BEGIN("restoreState1(#1)", "restoreState", "", 1) ;
	RESTORE_STATE("@LPRES_EXAMPLES@/experiments/+turbine_test.partition1/exp1/report.rpt.xml") ;
	CALC_END(1) ;
	return rc ;
}


void LPRES_EXAMPLES__Turbine_test_off_design_mapa::LPRES_EXAMPLES__getPreviousSettings()
{
...
void LPRES_EXAMPLES__Turbine_test_off_design_mapa::LPRES_EXAMPLES__restorePreviousSettings()
{
...
int LPRES_EXAMPLES__Turbine_test_off_design_mapa::LPRES_EXAMPLES__run_case1_calc2()
{
	// Local variables:
	int rc = 1;
	...
	std::string xParameterNames[606];
	{int __i=0; for(; __i <606; __i++) xParameterNames[__i] = ""; };
	std::string yOutputNames[3];
	{int __i=0; for(; __i <3; __i++) yOutputNames[__i] = ""; };
	double Mat[1818];
	memset(Mat,0,1818*sizeof(double));
	int MatOK[1818];
	memset(MatOK,0,1818*sizeof(int));
	int nrow = 0;
	int _vi1;
	int _vi2;
	int _vi3;
	...
	DEBUG_LEVEL = 4 ;
	CALC_BEGIN("parametric2(#2)", "parametric", "", 1) ;
	TIME = 0. ;
	SMETHOD = 1 ;
	TOLTYPE = 1 ;
	TOLERANCE = 1e-06 ;
	...
	unkR[72] = 50000. + _vi1 * 5000. ;
	NEW_BRANCH(getValueAsString("Turbine.rpm")) ;
	_vi2 = 0 ;
	while ( _vi2 <= 100 ) {
	unkR[42] = 0.08 + _vi2 * 0.0017 ;
	rcs = STEADY() ;
	nrow = nrow + 1 ;
	...
	matPrint(606, 3, Mat, 1, MatOK, xParameterNames, yOutputNames, "") ;
	CALC_END(1) ;
...
int LPRES_EXAMPLES__Turbine_test_off_design_mapa::LPRES_EXAMPLES__run_case1()
{
	// Local variables:
	int rc = 1;

	NEW_BRANCH("case1_restoreState1") ;
	rc = LPRES_EXAMPLES__run_case1_calc1() ;
	NEW_BRANCH("case1_parametric2") ;
...
void LPRES_EXAMPLES__Turbine_test_off_design_mapa::addExptVariables()
{
...
void LPRES_EXAMPLES__Turbine_test_off_design_mapa::runExperiment()
{
...
void LPRES_EXAMPLES__Turbine_test_off_design_mapa::initDefaultsLibraryGlobalsInExp()
{
}

/* Initialisation of variables in experiment*/
void LPRES_EXAMPLES__Turbine_test_off_design_mapa::initDefaultsExp()
{
}

/* Initialisation of boundaries*/
void LPRES_EXAMPLES__Turbine_test_off_design_mapa::evalBoundsExp(double TIME)
{
	if (m_boundsLaw)
		{(*m_boundsLaw)(TIME); return;}
}
/* Initialisation of delays in experiments*/
void LPRES_EXAMPLES__Turbine_test_off_design_mapa::initDelaysExpt()
{
}
...
try
{
	...
	LPRES_EXAMPLES__Turbine_test_off_design_mapa ecomodel;
#else
	LPRES_EXAMPLES__Turbine_test_off_design_mapa ecomodel(0,0,true);
...
{
	return new LPRES_EXAMPLES__Turbine_test_off_design_mapa(name,dirInstall,d);
}
...
SIMULA_EXPORT_C_EXP INTEG_SlimSimula *fcnExpCreate2(const char *name=NULL,const char *dirInstall=NULL,bool d=false)
{
	...
	try
	{
		INTEG_simula * tmp = new LPRES_EXAMPLES__Turbine_test_off_design_mapa(name,dirInstall,d);
