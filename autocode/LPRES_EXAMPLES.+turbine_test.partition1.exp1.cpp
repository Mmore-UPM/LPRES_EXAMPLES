...
//==================================================================
#include "LPRES_EXAMPLES.+turbine_test.partition1.exp1.h"

LPRES_EXAMPLES__Turbine_test_partition1_exp1* LPRES_EXAMPLES__Turbine_test_partition1_exp1::s_current= NULL;
LPRES_EXAMPLES__Turbine_test_partition1_exp1::LPRES_EXAMPLES__Turbine_test_partition1_exp1(const char* mgr,const char* installDir,bool dmode):LPRES_EXAMPLES__Turbine_test_partition1(mgr,installDir,dmode)
{
m_infoLibraryName = "LPRES_EXAMPLES";
m_infoExperimentName = "exp1";
m_infoExperimentFileName = "LPRES_EXAMPLES.+turbine_test.partition1.exp1";
m_infoExperimentFileNameExtra = "exp1";
m_infoExperimentDate = "05/06/2020 14:21:10.657000";
...
void LPRES_EXAMPLES__Turbine_test_partition1_exp1::initInternalModels()
{
  LPRES_EXAMPLES__Turbine_test_partition1::initInternalModels();
}


void LPRES_EXAMPLES__Turbine_test_partition1_exp1::LPRES_EXAMPLES__getPreviousSettings()
{
...
void LPRES_EXAMPLES__Turbine_test_partition1_exp1::LPRES_EXAMPLES__restorePreviousSettings()
{
...
int LPRES_EXAMPLES__Turbine_test_partition1_exp1::LPRES_EXAMPLES__run_case1_calc1()
{
	// Local variables:
	int rct = 1;
	int rc = 11;
...
int LPRES_EXAMPLES__Turbine_test_partition1_exp1::LPRES_EXAMPLES__run_case1()
{
	// Local variables:
	int rc = 1;
...
void LPRES_EXAMPLES__Turbine_test_partition1_exp1::addExptVariables()
{
...
void LPRES_EXAMPLES__Turbine_test_partition1_exp1::runExperiment()
{
...
void LPRES_EXAMPLES__Turbine_test_partition1_exp1::initDefaultsLibraryGlobalsInExp()
{
}

/* Initialisation of variables in experiment*/
void LPRES_EXAMPLES__Turbine_test_partition1_exp1::initDefaultsExp()
{
}

/* Initialisation of boundaries*/
void LPRES_EXAMPLES__Turbine_test_partition1_exp1::evalBoundsExp(double TIME)
{
	if (m_boundsLaw)
		{(*m_boundsLaw)(TIME); return;}
}
/* Initialisation of delays in experiments*/
void LPRES_EXAMPLES__Turbine_test_partition1_exp1::initDelaysExpt()
{
}
...
try
{
	...
	LPRES_EXAMPLES__Turbine_test_partition1_exp1 ecomodel;
#else
	LPRES_EXAMPLES__Turbine_test_partition1_exp1 ecomodel(0,0,true);
...
{
	return new LPRES_EXAMPLES__Turbine_test_partition1_exp1(name,dirInstall,d);
}
...
SIMULA_EXPORT_C_EXP INTEG_SlimSimula *fcnExpCreate2(const char *name=NULL,const char *dirInstall=NULL,bool d=false)
{
	...
	try
	{
		INTEG_simula * tmp = new LPRES_EXAMPLES__Turbine_test_partition1_exp1(name,dirInstall,d);
