...
//==================================================================
#include "LPRES_EXAMPLES.turbine.design_m_2.design_m_2.h"

LPRES_EXAMPLES__turbine_design_m_2_design_m_2* LPRES_EXAMPLES__turbine_design_m_2_design_m_2::s_current= NULL;
LPRES_EXAMPLES__turbine_design_m_2_design_m_2::LPRES_EXAMPLES__turbine_design_m_2_design_m_2(const char* mgr,const char* installDir,bool dmode):LPRES_EXAMPLES__turbine_design_m_2(mgr,installDir,dmode)
{
m_infoLibraryName = "LPRES_EXAMPLES";
m_infoExperimentName = "design_m_2";
m_infoExperimentFileName = "LPRES_EXAMPLES.turbine.design_m_2.design_m_2";
m_infoExperimentFileNameExtra = "design_m_2";
m_infoExperimentDate = "12/07/2020 21:29:48.294000";
...
void LPRES_EXAMPLES__turbine_design_m_2_design_m_2::initInternalModels()
{
  LPRES_EXAMPLES__turbine_design_m_2::initInternalModels();
}


void LPRES_EXAMPLES__turbine_design_m_2_design_m_2::LPRES_EXAMPLES__getPreviousSettings()
{
...
void LPRES_EXAMPLES__turbine_design_m_2_design_m_2::LPRES_EXAMPLES__restorePreviousSettings()
{
...
int LPRES_EXAMPLES__turbine_design_m_2_design_m_2::LPRES_EXAMPLES__run_case1_calc1()
{
	// Local variables:
	int rct = 1;
	int rc = 11;
...
int LPRES_EXAMPLES__turbine_design_m_2_design_m_2::LPRES_EXAMPLES__run_case1()
{
	// Local variables:
	int rc = 1;
...
void LPRES_EXAMPLES__turbine_design_m_2_design_m_2::addExptVariables()
{
...
void LPRES_EXAMPLES__turbine_design_m_2_design_m_2::runExperiment()
{
...
void LPRES_EXAMPLES__turbine_design_m_2_design_m_2::initDefaultsLibraryGlobalsInExp()
{
}

/* Initialisation of variables in experiment*/
void LPRES_EXAMPLES__turbine_design_m_2_design_m_2::initDefaultsExp()
{
}

/* Initialisation of boundaries*/
void LPRES_EXAMPLES__turbine_design_m_2_design_m_2::evalBoundsExp(double TIME)
{
	if (m_boundsLaw)
		{(*m_boundsLaw)(TIME); return;}
}
/* Initialisation of delays in experiments*/
void LPRES_EXAMPLES__turbine_design_m_2_design_m_2::initDelaysExpt()
{
}
...
try
{
	...
	LPRES_EXAMPLES__turbine_design_m_2_design_m_2 ecomodel;
#else
	LPRES_EXAMPLES__turbine_design_m_2_design_m_2 ecomodel(0,0,true);
...
{
	return new LPRES_EXAMPLES__turbine_design_m_2_design_m_2(name,dirInstall,d);
}
...
SIMULA_EXPORT_C_EXP INTEG_SlimSimula *fcnExpCreate2(const char *name=NULL,const char *dirInstall=NULL,bool d=false)
{
	...
	try
	{
		INTEG_simula * tmp = new LPRES_EXAMPLES__turbine_design_m_2_design_m_2(name,dirInstall,d);
...
{
	sprintf(experimentName,"%s","design_m_2");
	isDebug = false;
}
